...
function Form2({ formData, setFormData, setIsFormValid }) {
      ...
      <div className="form-grid-2x2 with-header">
        <div className="form-cell">
          ...
          <div className="input-wrapper">
            <select name="urunTipi" value={formData.urunTipi || ""} onChange={handleChange} className="urunSelect">
        ...
        <div className="form-cell">
          ...
          <div className="input-wrapper">
            <select
              ...
              onChange={handleChange} className="kullanimSelect"
            >
              <option value="">Seçiniz</option>
