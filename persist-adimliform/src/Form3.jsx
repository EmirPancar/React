...
function Form3() {
  ...
  const isValid = {
    ...
    dahaOnceSorun:
      formData.dahaOnceSorun === "evet" || formData.dahaOnceSorun === "hayir",
  };
  ...
  return (
    <>
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "60px" }}>
          ...
          <div className="form-cell" style={{ gap: "15px" }}>
            ...
            >
              ...
              <span
                className={getIconClass("dahaOnceSorun")}
                style={{ right: "-30px" }}
              />
            </div>
          </div>
        ...
        <div
          className="form-cell"
          style={{ alignItems: "flex-start", marginLeft: "-100px" }}
        >
          <label
            style={{ marginTop: "8px", width: "100px", marginRight: "5px" }}
          >
            Açıklama:
          </label>
          <div className="input-wrapper" style={{ position: "relative" }}>
            ...
            />
            <span
              className={getIconClass("sorunDetay")}
